...
public class UIManager : MonoBehaviour
{
    ...
    void Start()
{
    // Buscar la instancia persistente del GameManager
    GameManagerScript = GameManager.instance; 
    
    // Opcional: Si el botón de pausa se pierde, reasigna el evento por código
    if (PauseButton != null)
    {
        PauseButton.onClick.RemoveAllListeners();
        PauseButton.onClick.AddListener(() => GameManagerScript.Pause());
    }
